...
enum opt_code
{
  ...
  /* OPT_mfused_madd = 1213, */              /* -mfused-madd */
  OPT_mfxsr = 1214,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1215,             /* -mgeneral-regs-only */
  OPT_mglibc = 1216,                         /* -mglibc */
  OPT_mhard_float = 1217,                    /* -mhard-float */
  OPT_mhle = 1218,                           /* -mhle */
  OPT_miamcu = 1219,                         /* -miamcu */
  OPT_mieee_fp = 1220,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1221,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1222,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1223,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1224, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1225,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1226,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1227,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1228,                /* -mlong-double-80 */
  OPT_mlwp = 1229,                           /* -mlwp */
  OPT_mlzcnt = 1230,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1231,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1232,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1233,                  /* -mmitigate-rop */
  OPT_mmmx = 1234,                           /* -mmmx */
  OPT_mmovbe = 1235,                         /* -mmovbe */
  OPT_mmpx = 1236,                           /* -mmpx */
  OPT_mms_bitfields = 1237,                  /* -mms-bitfields */
  OPT_mmusl = 1238,                          /* -mmusl */
  OPT_mmwaitx = 1239,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1240,            /* -mno-align-stringops */
  OPT_mno_default = 1241,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1242,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1243,                  /* -mno-push-args */
  OPT_mno_red_zone = 1244,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1245,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1246,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1247,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1248,                          /* -mpc32 */
  OPT_mpc64 = 1249,                          /* -mpc64 */
  OPT_mpc80 = 1250,                          /* -mpc80 */
  OPT_mpclmul = 1251,                        /* -mpclmul */
  OPT_mpcommit = 1252,                       /* -mpcommit */
  OPT_mpku = 1253,                           /* -mpku */
  OPT_mpopcnt = 1254,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1255,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1256,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1257,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1258,                        /* -mprfchw */
  OPT_mpush_args = 1259,                     /* -mpush-args */
  OPT_mrdpid = 1260,                         /* -mrdpid */
  OPT_mrdrnd = 1261,                         /* -mrdrnd */
  OPT_mrdseed = 1262,                        /* -mrdseed */
  OPT_mrecip = 1263,                         /* -mrecip */
  OPT_mrecip_ = 1264,                        /* -mrecip= */
  OPT_mrecord_mcount = 1265,                 /* -mrecord-mcount */
  OPT_mred_zone = 1266,                      /* -mred-zone */
  OPT_mregparm_ = 1267,                      /* -mregparm= */
  OPT_mrtd = 1268,                           /* -mrtd */
  OPT_mrtm = 1269,                           /* -mrtm */
  OPT_msahf = 1270,                          /* -msahf */
  OPT_msgx = 1271,                           /* -msgx */
  OPT_msha = 1272,                           /* -msha */
  OPT_mskip_rax_setup = 1273,                /* -mskip-rax-setup */
  OPT_msoft_float = 1274,                    /* -msoft-float */
  OPT_msse = 1275,                           /* -msse */
  OPT_msse2 = 1276,                          /* -msse2 */
  OPT_msse2avx = 1277,                       /* -msse2avx */
  OPT_msse3 = 1278,                          /* -msse3 */
  OPT_msse4 = 1279,                          /* -msse4 */
  OPT_msse4_1 = 1280,                        /* -msse4.1 */
  OPT_msse4_2 = 1281,                        /* -msse4.2 */
  OPT_msse4a = 1282,                         /* -msse4a */
  /* OPT_msse5 = 1283, */                    /* -msse5 */
  OPT_msseregparm = 1284,                    /* -msseregparm */
  OPT_mssse3 = 1285,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1286,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1287,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1288,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1289,            /* -mstringop-strategy= */
  OPT_mstv = 1290,                           /* -mstv */
  OPT_mtbm = 1291,                           /* -mtbm */
  OPT_mtls_dialect_ = 1292,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1293,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1294,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1295,                         /* -mtune= */
  OPT_muclibc = 1296,                        /* -muclibc */
  OPT_mveclibabi_ = 1297,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1298,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1299,                    /* -mvzeroupper */
  OPT_mx32 = 1300,                           /* -mx32 */
  OPT_mxop = 1301,                           /* -mxop */
  OPT_mxsave = 1302,                         /* -mxsave */
  OPT_mxsavec = 1303,                        /* -mxsavec */
  OPT_mxsaveopt = 1304,                      /* -mxsaveopt */
  OPT_mxsaves = 1305,                        /* -mxsaves */
  OPT_n = 1306,                              /* -n */
  OPT_no_canonical_prefixes = 1307,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1308,              /* -no-integrated-cpp */
  OPT_no_pie = 1309,                         /* -no-pie */
  OPT_nocpp = 1310,                          /* -nocpp */
  OPT_nodefaultlibs = 1311,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1312,                   /* -nostartfiles */
  OPT_nostdinc = 1313,                       /* -nostdinc */
  OPT_nostdinc__ = 1314,                     /* -nostdinc++ */
  OPT_nostdlib = 1315,                       /* -nostdlib */
  OPT_o = 1316,                              /* -o */
  OPT_p = 1317,                              /* -p */
  OPT_pass_exit_codes = 1318,                /* -pass-exit-codes */
  /* OPT_pedantic = 1319, */                 /* -pedantic */
  OPT_pedantic_errors = 1320,                /* -pedantic-errors */
  OPT_pg = 1321,                             /* -pg */
  OPT_pie = 1322,                            /* -pie */
  OPT_pipe = 1323,                           /* -pipe */
  OPT_posix = 1324,                          /* -posix */
  OPT_print_file_name_ = 1325,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1326,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1327,          /* -print-multi-directory */
  OPT_print_multi_lib = 1328,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1329,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1330,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1331,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1332,               /* -print-prog-name= */
  OPT_print_search_dirs = 1333,              /* -print-search-dirs */
  OPT_print_sysroot = 1334,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1335,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1336,                        /* -profile */
  OPT_pthread = 1337,                        /* -pthread */
  OPT_quiet = 1338,                          /* -quiet */
  OPT_r = 1339,                              /* -r */
  OPT_rdynamic = 1340,                       /* -rdynamic */
  OPT_remap = 1341,                          /* -remap */
  OPT_s = 1342,                              /* -s */
  OPT_save_temps = 1343,                     /* -save-temps */
  OPT_save_temps_ = 1344,                    /* -save-temps= */
  OPT_shared = 1345,                         /* -shared */
  OPT_shared_libgcc = 1346,                  /* -shared-libgcc */
  /* OPT_specs = 1347, */                    /* -specs */
  OPT_specs_ = 1348,                         /* -specs= */
  OPT_static = 1349,                         /* -static */
  OPT_static_libasan = 1350,                 /* -static-libasan */
  OPT_static_libgcc = 1351,                  /* -static-libgcc */
  OPT_static_libgfortran = 1352,             /* -static-libgfortran */
  OPT_static_libgo = 1353,                   /* -static-libgo */
  OPT_static_liblsan = 1354,                 /* -static-liblsan */
  OPT_static_libmpx = 1355,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1356,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1357,               /* -static-libstdc++ */
  OPT_static_libtsan = 1358,                 /* -static-libtsan */
  OPT_static_libubsan = 1359,                /* -static-libubsan */
  /* OPT_std_c__03 = 1360, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1361, */                /* -std=c++0x */
  OPT_std_c__11 = 1362,                      /* -std=c++11 */
  OPT_std_c__14 = 1363,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1364, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1365, */                /* -std=c++1y */
  OPT_std_c__1z = 1366,                      /* -std=c++1z */
  OPT_std_c__98 = 1367,                      /* -std=c++98 */
  OPT_std_c11 = 1368,                        /* -std=c11 */
  /* OPT_std_c1x = 1369, */                  /* -std=c1x */
  ...
  OPT_std_f95 = 1377,                        /* -std=f95 */
  OPT_std_gnu = 1378,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1379, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1380, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1381,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1382,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1383, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1384, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1385,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1386,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1387,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1388, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1389, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1390,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1391,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1392, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1393, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1394,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1395, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1396, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1397, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1398,                     /* -std=legacy */
  OPT_symbolic = 1399,                       /* -symbolic */
  OPT_t = 1400,                              /* -t */
  OPT_time = 1401,                           /* -time */
  OPT_time_ = 1402,                          /* -time= */
  OPT_tno_android_cc = 1403,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1404,                 /* -tno-android-ld */
  OPT_traditional = 1405,                    /* -traditional */
  OPT_traditional_cpp = 1406,                /* -traditional-cpp */
  OPT_trigraphs = 1407,                      /* -trigraphs */
  OPT_u = 1408,                              /* -u */
  OPT_undef = 1409,                          /* -undef */
  OPT_v = 1410,                              /* -v */
  OPT_version = 1411,                        /* -version */
  OPT_w = 1412,                              /* -w */
  OPT_wrapper = 1413,                        /* -wrapper */
  OPT_x = 1414,                              /* -x */
  OPT_z = 1415,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
