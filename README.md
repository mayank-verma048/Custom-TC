...
TC for x86_64 architecture for kernel compilation , compiled from Linaro GCC 7.1.1 source with Graphite, Custom GSR and link time optimizations(lto).
